              ...
              <CardContent className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div className="text-center flex flex-col justify-center">
                    ...
                    <Button
                      size="lg"
                      className="moving-gradient text-white py-6 px-12 text-xl font-orbitron font-bold shadow-2xl transform hover:scale-80 transition-all duration-300 border-0 whitespace-nowrap"
