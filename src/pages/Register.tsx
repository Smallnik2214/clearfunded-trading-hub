...
const Register = () => {
  ...
  const countries = [
    ...
    "Kazakhstan", "Latvia", "Lithuania", "Malaysia", "Mexico", "Netherlands", "Norway", 
    "Philippines", "Poland", "Portugal", "Romania", "Russia", "Singapore", "Slovakia", 
  ...
  const countryCodes = [
    ...
    { code: "+260", country: "ZM" }, { code: "+261", country: "MG" }, { code: "+262", country: "YT" },
    { code: "+263", country: "ZW" }, { code: "+264", country: "NA" }, { code: "+265", country: "MW" },
    { code: "+266", country: "LS" }, { code: "+267", country: "BW" }, { code: "+268", country: "SZ" },
    { code: "+269", country: "KM" }, { code: "+290", country: "SH" }, { code: "+291", country: "ER" },
    { code: "+297", country: "AW" }, { code: "+298", country: "FO" }, { code: "+299", country: "GL" },
    { code: "+350", country: "GI" }, { code: "+351", country: "PT" }, { code: "+352", country: "LU" },
    { code: "+353", country: "IE" }, { code: "+354", country: "IS" }, { code: "+355", country: "AL" },
    { code: "+356", country: "MT" }, { code: "+357", country: "CY" }, { code: "+358", country: "FI" },
    { code: "+359", country: "BG" }, { code: "+370", country: "LT" }, { code: "+371", country: "LV" },
    { code: "+372", country: "EE" }, { code: "+373", country: "MD" }, { code: "+374", country: "AM" },
    { code: "+375", country: "BY" }, { code: "+376", country: "AD" }, { code: "+377", country: "MC" },
    { code: "+378", country: "SM" }, { code: "+380", country: "UA" }, { code: "+381", country: "RS" },
    ...
    { code: "+672", country: "AQ" }, { code: "+673", country: "BN" }, { code: "+674", country: "NR" },
    ...
    { code: "+684", country: "AS" }, { code: "+685", country: "WS" }, { code: "+686", country: "KI" },
