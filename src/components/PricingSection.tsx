        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="glass-card border-aurora-cyan/20 hover:border-aurora-cyan/40 transition-all duration-300 hover:scale-105">
            ...
            <CardContent className="space-y-4">
              {pricingData["1-Phase"].map((item, index) => <div key={index} className="flex items-center justify-between p-4 glass-card rounded-lg hover:border-aurora-cyan/40 border border-aurora-cyan/20 transition-all cursor-pointer hover:scale-105" onClick={() => console.log(`Selected 1-Phase ${item.size}$ account`)}>
              ...
              <Button className="w-full moving-gradient text-white font-bold py-3 text-lg font-orbitron border-0" onClick={() => window.location.href = "/register"}>
                Choose 1-Phase
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="glass-card border-aurora-cyan/20 hover:border-aurora-cyan/40 transition-all duration-300 hover:scale-105">
            ...
            <CardContent className="space-y-4">
              {pricingData["2-Phase"].map((item, index) => <div key={index} className="flex items-center justify-between p-4 glass-card rounded-lg hover:border-aurora-cyan/40 border border-aurora-cyan/20 transition-all cursor-pointer hover:scale-105" onClick={() => console.log(`Selected 2-Phase ${item.size}$ account`)}>
                  <div className="flex items-center gap-3">
                    <Check className="h-5 w-5 text-aurora-cyan" />
                    <span className="font-semibold text-white font-orbitron">{item.size}$ Account</span>
                  </div>
